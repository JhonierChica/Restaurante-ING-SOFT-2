      ...
      <div className="login-welcome-section">
        <div className="login-welcome-content">
          <div className="login-logo-container">
            <img 
              src="/logo-mrDEL SI��-removebg.png" 
              alt="La Terraza del Sin� Logo" 
            ...
            <div className="login-logo-fallback" style={{display: 'none'}}>
              <div className="logo-text">
                ...
                <span className="logo-DEL SI��">DEL SI��</span>
              </div>
          ...
          <p className="login-welcome-subtitle">
           Este es un sistema exclusivo para el personal autorizado de La Terraza del Sin�.
          </p>
        </div>
      </div>
      ...
      <div className="login-form-section">
        <div className="login-form-container">
          ...
          <div className="login-footer">
            <span>POWERED BY La Terraza del Sin� SYSTEMS</span>
